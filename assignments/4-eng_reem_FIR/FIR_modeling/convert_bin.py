...
def calculate_error(estimated, actual):
    ...
    """
    return (estimated - actual) / actual * 100  # Format as percentage with 2 decimal places


def write_to_file(file_name, xn, xn_filtered, places_int, places_float, mode="w"):
    """
    ...
    for input, output in zip(xn, xn_filtered):
        ...
        op_dec = convert_two_complement2decimal(op_, places_int, places_float)
